...
if(poldegree(f)==0, \
        ...
        if(poldegree(f)==0, \
                ...
                if(poldegree(f)==0, \
                        if(deg2 == 7 , \
                                if(deg1==7, semi71 = semi71 + 1, if(deg1==13, semi72=semi72+1, if( deg1=19,semi73=semi73+1))), \
                                if( deg2 ==14 , \
                                        if(deg1=14, semi72 = semi72 + 1, if(deg1=20, semi73=semi73+1 ))); \
...
print("The number of 5+1 semi-smooth (6) polynomials is ",semi61);
print("The number of 5+1 semi-smooth (12) polynomials is ",semi62);
print("The number of 5+1 semi-smooth (18) polynomials is ",semi63);
